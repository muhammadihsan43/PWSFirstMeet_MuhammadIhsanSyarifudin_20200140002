 ...
 * @author hp
 */
public class keterangan_pembelian extends javax.swing.JFrame {

    /**
     * Creates new form keterangan_pembelian
     */
    public keterangan_pembelian() {
        initComponents();
        table();
    }
    void cari(){
        ...
        try {
            String sql = "SELECT * FROM keterangan_pembelian WHERE id_barang like '%" + txt_idNota.getText() + "%'";
    ...
    private void initComponents() {
        ...
        jLabel3.setText("KATERANGAN PEMEBELIAN");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addComponent(txt_jumlahBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // TODO add your handling code here:
        try{
            String sql = "UPDATE barang SET id_barang='" + txt_idBarang.getText() + "',nama_barang ='" + txt_jumlahBarang.getText() + "',harga ='" + txt_harga.getText() + "',id_pemasok ='" + txt_idNota.getText() + "' WHERE id_barang='" +txt_idBarang.getText() + "'";
            Connection con = (Connection) Koneksi.getCOnnection();
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        try{
            String sql = "INSERT INTO barang VALUES ('" + txt_idBarang.getText() + "','" + txt_jumlahBarang.getText() + "','" + txt_harga.getText() + "','" +  txt_idNota.getText() + "')";
            Connection con = (Connection) Koneksi.getCOnnection();
            PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(keterangan_pembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new keterangan_pembelian().setVisible(true);
            }
        });
    }
